...
export const gatewayRewardMappings = pgTable(
  'gateway_reward_mappings',
  {
    ...
    canAdopt: boolean('can_adopt').notNull().default(false),
...
export const pets = pgTable(
  'pets',
  {
    ...
    levelBonusHp: integer('level_bonus_hp').notNull().default(0),
    levelBonusAtk: integer('level_bonus_atk').notNull().default(0),
    levelBonusDef: integer('level_bonus_def').notNull().default(0),
    levelBonusSpd: integer('level_bonus_spd').notNull().default(0),
    levelBonusGain: integer('level_bonus_gain').notNull().default(0),
    levelBonusPow: integer('level_bonus_pow').notNull().default(0),
    ...
    consumedByPetId: uuid('consumed_by_pet_id').references((): AnyPgColumn => pets.id),
