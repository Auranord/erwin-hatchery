      ...
      slots: cellsForGrid(
        ...
        petRows.map((row) => ({
          ...
          item: {
            ...
            classMainStat: row.classMainStat as PetStatId,
            classSecondaryStatOne: row.classSecondaryStatOne as PetStatId,
            classSecondaryStatTwo: row.classSecondaryStatTwo as PetStatId,
