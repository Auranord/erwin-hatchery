...
const { appOwnershipKeyForEggType, gatewayLocalRewardTypeForEggType, gatewayRewardPlanForEggType, localRewardTypeForEggType } =
...
const currentGatewayRewardSchema = z
  .object({
